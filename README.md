...
Mini project analyzing mental health trends using Python, SQLite, Excel, JSON, and Power BI. Collected, cleaned, and structured data, performed analysis, and created an interactive dashboard to visualize patterns and insights across factors affecting mental health.
